...
elseif ~Estacionario
    ...
    panelDesplazable = uipanel('Parent',wb);
    ...
    if Isot
        ...
        if factorCoContraCorriente==+1
            ...
            if Incompresible
                ...
                h=-1*ones(1,N);
                for i=1:N
                    h(i)=subplot(ceil(N/2),2,i,'Parent',panelParaGraficas);
                end
        ...
        elseif factorCoContraCorriente==-1
            ...
            if Incompresible
                ...
                for j=2:nTiempos
                    ...
                    dy_en_dz(:,:,j)=sol.du;
                    % Refrescar ventana de estatus
                    plotStep(0,t(j),z,squeeze(Y(1:end,:,j)),...
                        'WaitBar',wb,'TotalTime',t(length(t)),...
                        'AxesToPlotOn',h,...
                        'uEdoEst',[C_est;T_est;Ta_est],...
                        'nombresDeVariables',nombresDeVariables);
...
if nargin >= 10 ...
    ...
    if nargin > 10 ...
        ...
        if diferencia_porcentual <= eps*100; % Detect u-u_steady = 0
