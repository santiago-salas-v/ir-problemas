...
elseif ~isempty(Datos)
    ...
    Estacionario    = Datos(strcmp(Datos,'Estacionario'),:);
    Isot            = Datos(strcmp(Datos,'Isot'),:);
    Co_Corriente    = Datos(strcmp(Datos,'Co_Corriente'),:);    
    Incompresible   = Datos(strcmp(Datos,'Incompresible'),:);    
    
    delta_Hf        = Datos(strcmp(Datos,'delta_Hf'),:);
    Cp_Molares      = Datos(strcmp(Datos,'Cp_Molares'),:);
    rhoCp_a         = Datos(strcmp(Datos,'rhoCp_a'),:);
    
    E               = Datos(strcmp(Datos,'E'),:);
    k0              = Datos(strcmp(Datos,'k0'),:);
    T0ref           = Datos(strcmp(Datos,'T0ref'),:);
    Coefs_esteq     = Datos(strcmp(Datos,'Coefs_esteq'),:);
    Exponentes_r    = Datos(strcmp(Datos,'Exponentes_r'),:);
    Ref_Selectividad = Datos(strcmp(Datos,'Ref_Selectividad'),:);
    Ref_Rendimiento  = Datos(strcmp(Datos,'Ref_Rendimiento'),:);
        
    C0              = Datos(strcmp(Datos,'C0'),:);
    C_t0            = Datos(strcmp(Datos,'C_t0'),:);
    T0              = Datos(strcmp(Datos,'T0'),:);
    T_t0            = Datos(strcmp(Datos,'T_t0'),:);
