...
ComponentesDatos    = get(handles.uitable2,'Data');
OperacionDatos      = get(handles.uitable1,'Data');
ReaccionesDatos     = get(handles.uitable3,'Data');
...
if ~isempty(n) && ~isempty(Nr) && ~isempty(Datos)
    for i=1:n
        delta_Hf(i)     = ...
            ComponentesDatos{strcmp(ComponentesDatos,...
            ['delta_Hf_',num2str(i)]),2};
        Cp_Molares(i)   = ComponentesDatos{strcmp(ComponentesDatos,...
            ['Cp_Molares_',num2str(i)]),2};
    end
    for i=1:Nr
        k0(i)                       = ...
            ReaccionesDatos{strcmp(ReaccionesDatos,...
            ['k0_',num2str(i)]),2};
        E(i)                        = ...
            ReaccionesDatos{strcmp(ReaccionesDatos,...
            ['E_',num2str(i)]),2};
...
%     OperacionDatos{strcmp(OperacionDatos,'Incompresible'),2};
% Datos{strcmp(Datos,'Isot'),2}           = ...
%     OperacionDatos{strcmp(OperacionDatos,'Isot'),2};
% Datos{strcmp(Datos,'delta_Hf'),2}       = delta_Hf;
% Datos{strcmp(Datos,'Cp_Molares'),2}     = Cp_Molares;
% Datos{strcmp(Datos,'Coefs_esteq'),2}    = Coefs_esteq;
% Datos{strcmp(Datos,'Exponentes_r'),2}	= Exponentes_r;
% Datos{strcmp(Datos,'E'),2}              = E;
% Datos{strcmp(Datos,'k0'),2}             = k0;
% Datos{strcmp(Datos,'T0ref'),2}          = ...
%     ReaccionesDatos{strcmp(ReaccionesDatos,'T0ref'),2};
% Datos{strcmp(Datos,'Ref_Selectividad'),2}   = ...
%     ReaccionesDatos{strcmp(ReaccionesDatos,'Ref_Selectividad'),2};
% Datos{strcmp(Datos,'Ref_Rendimiento'),2}    = ...
%     ReaccionesDatos{strcmp(ReaccionesDatos,'Ref_Rendimiento'),2};
...
for i=1:size(Datos,1)
    if      ~strcmp(Datos{i,1},'OPERACIÓN') &&...
        ...
        elseif any(strcmp(OperacionDatos(:,1),Datos{i,1}))
            Datos{i,2} = ...
                OperacionDatos{strcmp(OperacionDatos,Datos{i,1}),2};
        elseif any(strcmp(ReaccionesDatos(:,1),Datos{i,1}))
            Datos{i,2} = ...
                ReaccionesDatos{strcmp(ReaccionesDatos,Datos{i,1}),2};
        elseif any(strcmp(ComponentesDatos(:,1),Datos{i,1}))
            Datos{i,2} = ...
                ComponentesDatos{strcmp(ComponentesDatos,Datos{i,1}),2};
        end
    end
end
...
switch tipo
    ...
    case 'CSTR'
        Datos{strcmp(Datos,'Estacionario'),2}   = ...
            OperacionDatos{strcmp(OperacionDatos,'Estacionario'),2};        
    case 'PFR'
        Datos{strcmp(Datos,'Estacionario'),2}   = ...
            OperacionDatos{strcmp(OperacionDatos,'Estacionario'),2};
        Datos{strcmp(Datos,'Co_Corriente'),2}   = ...
            OperacionDatos{strcmp(OperacionDatos,'Co_Corriente'),2};
end
