...
serie=hObject;
marcadores={'none','+','o','*','.','x','square','diamond','^','<','v','>','pentagram','hexagram'};
...
figure5=figure('Menu','none','Toolbar','none',...
    ...
    'Position',[screenSize(3:4)/2,200,2*24+20]);
panel2=uipanel('Parent',figure5,'Title','Propiedades de serie',...
    'BackgroundColor',[255,255,255]/255);

htext2=uicontrol(panel2,'Style','text',...
    'String','MARCADOR','Position',[4+22,4+22,0+22,0+22],...
    'BackgroundColor',[255,255,255]/255);
extent2=get(htext2,'Extent');
set(htext2,'Position',[4+22,4+22,0,0]+extent2);
...
popup=uicontrol(panel2,'Style','popupmenu','String',...
    marcadores,...
    'Position',[4+24+extent2(3)+22,4+22,0+22+10,0+22],...
    'BackgroundColor',[1,1,1],...
...
set(popup,'Position',[4+24+extent2(3)+22,4+22,0+22+10+extent3(3),0+22]);
...
htext=uicontrol(panel2,'Style','text',...
    'String','LÍNEA','Position',[4+22,4+0,0+22,0+22],...
    'BackgroundColor',[255,255,255]/255);
extent=get(htext,'Extent');
set(htext,'Position',[4+22,4+0,0,0]+extent);
colorFrame=uicontrol(panel2,'Style','frame',...
    'BackgroundColor',[1,1,1],...
    'Position',[4+24+extent2(3),4+0,0+22,0+22]);
...
uicontrol(panel2,'CData',...
    ...
    'Style','pushbutton','Position',[4+0,4+0,22,22],...
    'Callback',...
